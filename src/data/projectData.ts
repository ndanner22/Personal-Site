...
export const projects: Project[] = [
  {
    ...
    image: "../../images/stay-fresh.png",
    extraimages: [
      "../../images/stay-fresh-2.png",
      "../../images/main-wireframes-stayfresh.png",
      "../../images/wireframes-stayfresh-2.png",
      "../../images/wireframes-stayfresh-3.png",
      "../../images/stayfresh-component-tree.png",
      "../../images/stayfresh-user-stories.png",
      "../../images/stayfresh-task-breakdown.png",
      "../../images/stayfresh-trello.png",
    ],
  ...
  },
  {
    ...
    extraimages: [
      ...
      "../../images/nc-news-fe-1.png",
      "../../images/nc-news-fe-2.png",
      "../../images/nc-news-fe-3.png",
    ],
  ...
  },
  {
    ...
    image: "../../images/nc-news-be-1.png",
    livelink: "https://new-engine.onrender.com/api",
    extraimages: [
      "../../images/nc-news-be-2.png",
      "../../images/nc-news-be-3.png",
    ],
    alt: "picture of JavaScript code",
    github: "https://github.com/ndanner22/news-engine",
    projectlink: "",
    stack: ["javascript", "postgres", "nodejs", "express", "html", "css"],
    longdescription: [
